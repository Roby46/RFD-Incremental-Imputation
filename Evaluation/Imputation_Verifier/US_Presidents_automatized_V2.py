...
xml_file = 'XML Files/US_Pres_similarity_rules.xml'
# Carica il file XML
...
def analyze_imputation_quality(version, approach, MV, xml_file):
    dataset_name = f"US_Presidents_3754_{MV}_{version}"

    # Esempio di utilizzo
    missing_dataset_path = f'../../Datasets/Missing_Datasets/US_Presidents_3754/{dataset_name}.csv'
    full_dataset_path = f'../../Datasets/Preprocessed_Datasets/US_Presidents_3754.csv'
    results_path = ""
    if (approach == "Baseline"):
        results_path = f'../Imputation_Results/Imputation_Baseline_Results/US_Presidents_3754/{version}/Baseline_{dataset_name}.csv'
    elif (approach == "Pipeline_noRev"):
        results_path = f'../Imputation_Results/Imputation_noRestoring_Results/US_Presidents_3754/{version}/{dataset_name}.csv'
    elif (approach == "Baseline20"):
        results_path = f'../Imputation_Results/Imputation_Baseline_20_Results/US_Presidents_3754/{version}/Baseline_{dataset_name}.csv'
    elif (approach == "Pipeline"):
        results_path = f'../Imputation_Results/Imputation_Pipeline_Results/US_Presidents_3754/{version}/{dataset_name}.csv'
    elif (approach == "Hybrid"):
        results_path = f'../Imputation_Results/Imputation_Hybrid_Results/US_Presidents_3754/{version}/{dataset_name}.csv'
...
def checkResults(version, approach, MV,xml_file):
    ...
    if (approach == "Baseline"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Baseline_Results/US_Presidents_3754/{version}/Baseline_US_Presidents_3754_{MV}_{version}.csv",
            sep=';')
    elif (approach == "Pipeline_noRev"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_noRestoring_Results/US_Presidents_3754/{version}/US_Presidents_3754_{MV}_{version}.csv",
            sep=';')
    elif (approach == "Baseline20"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Baseline_20_Results/US_Presidents_3754/{version}/Baseline_US_Presidents_3754_{MV}_{version}.csv",
            sep=';')
    elif (approach == "Pipeline"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Pipeline_Results/US_Presidents_3754/{version}/US_Presidents_3754_{MV}_{version}.csv",
            sep=';')
    elif (approach == "Hybrid"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Hybrid_Results/US_Presidents_3754/{version}/US_Presidents_3754_{MV}_{version}.csv",
            sep=';')
    ...
    row_data = ["US_Presidents_3754"] + [approach] + [MV] + [str(recall)] + [str(precision)] + [str(version)] + [
...
versions=[1,2,3,4,5]
MVs = [375, 751, 1126, 1502, 1877, 3754, 7508, 11262, 15016, 18770]  # Lista dei MVs
