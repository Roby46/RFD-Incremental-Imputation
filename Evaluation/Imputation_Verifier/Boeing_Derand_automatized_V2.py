...
def analyze_imputation_quality(version, approach, MV, xml_file):
    ...
    if (approach == "BaselineD"):
        results_path = f'../Imputation_Results/Imputation_Baseline_Derand_Results/Boeing_898/{version}/{dataset_name}.csv'
    elif (approach == "Derand"):
        results_path = f'../Imputation_Results/Imputation_Derand_Results/Boeing_898/{version}/{dataset_name}.csv'
...
def checkResults(version, approach, MV,xml_file):
    ...
    if (approach == "BaselineD"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Baseline_Derand_Results/Boeing_898/{version}/Boeing_898_{MV}_{version}.csv",
            sep=';')
    elif (approach == "Derand"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Derand_Results/Boeing_898/{version}/Boeing_898_{MV}_{version}.csv",
            sep=';')
