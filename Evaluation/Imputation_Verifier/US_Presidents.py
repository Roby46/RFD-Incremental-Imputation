...
# Carica il file XML
tree = ET.parse(f'XML Files/US_Pres_similarity_rules.xml')
root = tree.getroot()
...
if(approach=="Baseline"):
    df=pd.read_csv(f"../Imputation_Results/Imputation_Baseline_Results/US_Presidents_3754/{version}/Baseline_US_Presidents_3754_{MV}_{version}.csv", sep=';')
elif(approach=="Pipeline_noRev"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_noRestoring_Results/US_Presidents_3754/{version}/US_Presidents_3754_{MV}_{version}.csv", sep=';')
elif(approach=="Baseline20"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_Baseline_20_Results/US_Presidents_3754/{version}/Baseline_US_Presidents_3754_{MV}_{version}.csv", sep=';')
elif(approach=="Pipeline"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_Pipeline_Results/US_Presidents_3754/{version}/US_Presidents_3754_{MV}_{version}.csv", sep=';')
elif(approach=="Hybrid"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_Hybrid_Results/US_Presidents_3754/{version}/US_Presidents_3754_{MV}_{version}.csv", sep=';')
