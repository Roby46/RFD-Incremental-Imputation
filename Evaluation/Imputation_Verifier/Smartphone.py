...
# Carica il file XML
tree = ET.parse(f'XML Files/smartphones_similarity_rules.xml')
root = tree.getroot()
...
if(approach=="Baseline"):
    df=pd.read_csv(f"../Imputation_Results/Imputation_Baseline_Results/smartphones_823/{version}/Baseline_smartphones_823_{MV}_{version}.csv", sep=';')
elif(approach=="Pipeline_noRev"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_noRestoring_Results/smartphones_823/{version}/smartphones_823_{MV}_{version}.csv", sep=';')
elif(approach=="Baseline20"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_Baseline_20_Results/smartphones_823/{version}/Baseline_smartphones_823_{MV}_{version}.csv", sep=';')
elif(approach=="Pipeline"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_Pipeline_Results/smartphones_823/{version}/smartphones_823_{MV}_{version}.csv", sep=';')
elif(approach=="Hybrid"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_Hybrid_Results/smartphones_823/{version}/smartphones_823_{MV}_{version}.csv", sep=';')
