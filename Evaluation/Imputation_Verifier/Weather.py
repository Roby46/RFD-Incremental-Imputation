...
# Carica il file XML
tree = ET.parse(f'XML Files/Weather_similarity_rules.xml')
root = tree.getroot()
...
if(approach=="Baseline"):
    df=pd.read_csv(f"../Imputation_Results/Imputation_Baseline_Results/Weather_2500/{version}/Baseline_Weather_2500_{MV}_{version}.csv", sep=';')
elif(approach=="Pipeline_noRev"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_noRestoring_Results/Weather_2500/{version}/Weather_2500_{MV}_{version}.csv", sep=';')
elif(approach=="Baseline20"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_Baseline_20_Results/Weather_2500/{version}/Baseline_Weather_2500_{MV}_{version}.csv", sep=';')
elif(approach=="Pipeline"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_Pipeline_Results/Weather_2500/{version}/Weather_2500_{MV}_{version}.csv", sep=';')
elif(approach=="Hybrid"):
    df = pd.read_csv(f"../Imputation_Results/Imputation_Hybrid_Results/Weather_2500/{version}/Weather_2500_{MV}_{version}.csv", sep=';')
