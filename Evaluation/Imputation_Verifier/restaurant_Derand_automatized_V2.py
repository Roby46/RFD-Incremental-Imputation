...
def analyze_imputation_quality(version, approach, MV, xml_file):
    ...
    results_path = ""
    if (approach == "BaselineD"):
        results_path = f'../Imputation_Results/Imputation_Baseline_Derand_Results/restaurant/{version}/{dataset_name}.csv'
    elif (approach == "Derand"):
        results_path = f'../Imputation_Results/Imputation_Derand_Results/restaurant/{version}/{dataset_name}.csv'
...
def checkResults(version, approach, MV,xml_file):
    ...
    if (approach == "BaselineD"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Baseline_Derand_Results/restaurant/{version}/restaurant_{MV}_{version}.csv",
            sep=';')
    elif (approach == "Derand"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Derand_Results/restaurant/{version}/restaurant_{MV}_{version}.csv",
            sep=';')
    ...
    all_results_path = f"../ALL_Results_Derand.csv"
...
#approaches=["Derand", "BaselineD"]
approaches=["Derand"]
versions=[1]
MVs = [52,104,156,207,259]
