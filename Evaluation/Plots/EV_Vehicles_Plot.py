...
axs[0].plot(r1, EV_VehiclesRecPipeline, marker="v", markersize=5, color="#F0002B", zorder=3)
axs[0].plot(r1, EV_VehiclesRecBaseline, marker="v", markersize=5, color="#0072B2", zorder=2)   #0072b2
axs[0].plot(r1, EV_VehiclesRecPipelineNoRev, marker="v", markersize=5, color="#00D942", zorder=2)   #0072b2
axs[0].plot(r1, EV_VehiclesRecHybrid, marker="v", markersize=5, color="#02AEC6", zorder=3)



axs[1].plot(r1, EV_VehiclesPrePipeline, marker="v", markersize=5, color="#F0002B",zorder=3)
axs[1].plot(r1, EV_VehiclesPreBaseline, marker="v", markersize=5, color="#0072B2", zorder=2)
axs[1].plot(r1, EV_VehiclesPrePipelineNoRev, marker="v", markersize=5, color="#00D942", zorder=2)
axs[1].plot(r1, EV_VehiclesPreHybrid, marker="v", markersize=5, color="#02AEC6",zorder=3)
...
legend = fig.legend(handles=[legend_artist1, legend_artist2, legend_artist3, legend_artist4], loc='upper center', ncol=4, bbox_to_anchor=(0.5, 0.95), shadow=True)
