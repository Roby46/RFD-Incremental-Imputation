...
df = pd.read_csv("../../Datasets/Original_Datasets/Pollution.csv", sep=',')
...
columns_to_keep = [
    "Country", "Region", "Year", "Source", "Contam", "pH",
    "NO3", "Pb", "Bact", "AccessClean", "Diarrhea", "IMR", "GDP", "Sanit", "Treatment"
]

# Filtra il DataFrame mantenendo solo le colonne scelte
...
new_df = new_df.sample(1500)

# Crea un nuovo file CSV ripulito
filename = f"../../Datasets/Preprocessed_Datasets/Pollution_{len(new_df)}.csv"
