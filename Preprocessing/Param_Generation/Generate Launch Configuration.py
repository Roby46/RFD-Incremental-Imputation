...
def generate_launch_file(dataset_name, command_string, template, output_dir, reevaluation, algoritmo):
    launch_content = template.format(
        dataset_name=dataset_name,
        command_string=command_string
    )
    filename = os.path.join(output_dir, f"{algoritmo}_{dataset_name}_{reevaluation}.launch")
...
output_dir = f"./Launch_Files/{algoritmo}_{reevaluation}_{dataset}"
os.makedirs(output_dir, exist_ok=True)

# Generate the .launch files
for dataset_name, command_string in commands:
    generate_launch_file(dataset_name, command_string, launch_template, output_dir, reevaluation, algoritmo)
