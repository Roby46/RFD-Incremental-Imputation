...
# Carica il file XML
tree = ET.parse(f'XML Files/Cars_similarity_rules.xml')
root = tree.getroot()
...
df = pd.read_csv(r"../Imputation_Results/Imputation_noRestoring_Results/EV_Vehicles/2/cars_1096_18.csv", sep=';')
