...
df_EV_Vehicles_=df.loc[df['dataset'] == 'EV_Vehicles_4000' ]
...
EV_VehiclesRMSEPipelineNoRevV1=df_EV_Vehicles_PipelineNoRevV1['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEPipelineNoRevV2=df_EV_Vehicles_PipelineNoRevV2['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEPipelineNoRevV3=df_EV_Vehicles_PipelineNoRevV3['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEPipelineNoRevV4=df_EV_Vehicles_PipelineNoRevV4['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEPipelineNoRevV5=df_EV_Vehicles_PipelineNoRevV5['rmse'].to_numpy().astype(float)
...
EV_VehiclesRMSEPipelineV1=df_EV_Vehicles_PipelineV1['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEPipelineV2=df_EV_Vehicles_PipelineV2['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEPipelineV3=df_EV_Vehicles_PipelineV3['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEPipelineV4=df_EV_Vehicles_PipelineV4['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEPipelineV5=df_EV_Vehicles_PipelineV5['rmse'].to_numpy().astype(float)
...
EV_VehiclesRMSEBaselineV1=df_EV_Vehicles_BaselineV1['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEBaselineV2=df_EV_Vehicles_BaselineV2['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEBaselineV3=df_EV_Vehicles_BaselineV3['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEBaselineV4=df_EV_Vehicles_BaselineV4['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEBaselineV5=df_EV_Vehicles_BaselineV5['rmse'].to_numpy().astype(float)
...
EV_VehiclesRMSEBaseline20V1=df_EV_Vehicles_Baseline20V1['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEBaseline20V2=df_EV_Vehicles_Baseline20V2['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEBaseline20V3=df_EV_Vehicles_Baseline20V3['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEBaseline20V4=df_EV_Vehicles_Baseline20V4['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEBaseline20V5=df_EV_Vehicles_Baseline20V5['rmse'].to_numpy().astype(float)
...
EV_VehiclesRMSEHybridV1=df_EV_Vehicles_HybridV1['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEHybridV2=df_EV_Vehicles_HybridV2['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEHybridV3=df_EV_Vehicles_HybridV3['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEHybridV4=df_EV_Vehicles_HybridV4['rmse'].to_numpy().astype(float)
EV_VehiclesRMSEHybridV5=df_EV_Vehicles_HybridV5['rmse'].to_numpy().astype(float)
...
arrays = [EV_VehiclesRMSEPipelineNoRevV1, EV_VehiclesRMSEPipelineNoRevV2, EV_VehiclesRMSEPipelineNoRevV3, EV_VehiclesRMSEPipelineNoRevV4, EV_VehiclesRMSEPipelineNoRevV5]
EV_VehiclesRMSEPipelineNoRev = np.mean(arrays, axis=0)
...
arrays = [EV_VehiclesRMSEBaselineV1, EV_VehiclesRMSEBaselineV2, EV_VehiclesRMSEBaselineV3, EV_VehiclesRMSEBaselineV4, EV_VehiclesRMSEBaselineV5]
EV_VehiclesRMSEBaseline = np.mean(arrays, axis=0)
...
arrays = [EV_VehiclesRMSEBaseline20V1, EV_VehiclesRMSEBaseline20V2, EV_VehiclesRMSEBaseline20V3, EV_VehiclesRMSEBaseline20V4, EV_VehiclesRMSEBaseline20V5]
EV_VehiclesRMSEBaseline20 = np.mean(arrays, axis=0)
...
arrays = [EV_VehiclesRMSEHybridV1, EV_VehiclesRMSEHybridV2, EV_VehiclesRMSEHybridV3, EV_VehiclesRMSEHybridV4, EV_VehiclesRMSEHybridV5]
EV_VehiclesRMSEHybrid = np.mean(arrays, axis=0)
...
arrays = [EV_VehiclesRMSEPipelineV1, EV_VehiclesRMSEPipelineV2, EV_VehiclesRMSEPipelineV3, EV_VehiclesRMSEPipelineV4, EV_VehiclesRMSEPipelineV5]
EV_VehiclesRMSEPipeline = np.mean(arrays, axis=0)
...
# EV_VehiclesF0_5PipelineNoRevNoRev = (1 + beta**2) * (EV_VehiclesPrePipelineNoRevNoRev * EV_VehiclesRecPipelineNoRevNoRev) / ((beta**2 * EV_VehiclesPrePipelineNoRevNoRev) + EV_VehiclesRecPipelineNoRevNoRev)
...
axs[4].plot(r1, EV_VehiclesRMSEPipeline, marker="x", markersize=8, color="#ff0000",zorder=3)
# axs[4].plot(r1, EV_VehiclesRMSEBaseline, marker="+", markersize=10, color="#00C3CC", zorder=2)
axs[4].plot(r1, EV_VehiclesRMSEBaseline20, marker="2", markersize=10, color="#00748f", zorder=2)
axs[4].plot(r1, EV_VehiclesRMSEPipelineNoRev, marker="o", markersize=5, color="#FFA600", zorder=2)
axs[4].plot(r1, EV_VehiclesRMSEHybrid, marker="2", markersize=10, color="#61a44f",zorder=3,linestyle="dashdot")
...
plt.savefig("EV_Vehicles4000.pdf", bbox_inches='tight')
plt.show()
