...
xml_file = 'XML Files/Superstore_similarity_rules.xml'
# Carica il file XML
...
def analyze_imputation_quality(version, approach, MV, xml_file):
    dataset_name = f"superstore_4500_{MV}_{version}"

    # Esempio di utilizzo
    missing_dataset_path = f'../../Datasets/Missing_Datasets/superstore_4500/{dataset_name}.csv'
    full_dataset_path = f'../../Datasets/Preprocessed_Datasets/superstore_4500.csv'
    results_path = ""
    if (approach == "Baseline"):
        results_path = f'../Imputation_Results/Imputation_Baseline_Results/superstore_4500/{version}/Baseline_{dataset_name}.csv'
    elif (approach == "Pipeline_noRev"):
        results_path = f'../Imputation_Results/Imputation_noRestoring_Results/superstore_4500/{version}/{dataset_name}.csv'
    elif (approach == "Baseline20"):
        results_path = f'../Imputation_Results/Imputation_Baseline_20_Results/superstore_4500/{version}/Baseline_{dataset_name}.csv'
...
def checkResults(version, approach, MV,xml_file):
    ...
    if (approach == "Baseline"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Baseline_Results/superstore_4500/{version}/Baseline_superstore_4500_{MV}_{version}.csv",
            sep=';')
    elif (approach == "Pipeline_noRev"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_noRestoring_Results/superstore_4500/{version}/superstore_4500_{MV}_{version}.csv",
            sep=';')
    elif (approach == "Baseline20"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Baseline_20_Results/superstore_4500/{version}/Baseline_superstore_4500_{MV}_{version}.csv",
            sep=';')
    elif (approach == "Pipeline"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Pipeline_Results/superstore_4500/{version}/superstore_4500_{MV}_{version}.csv",
            sep=';')
    elif (approach == "Hybrid"):
        df = pd.read_csv(
            f"../Imputation_Results/Imputation_Hybrid_Results/superstore_4500/{version}/superstore_4500_{MV}_{version}.csv",
            sep=';')
    ...
    row_data = ["superstore_4500"] + [approach] + [MV] + [str(recall)] + [str(precision)] + [str(version)] + [
